 ...
 *
 */
public class votealarmReciver extends WakefulBroadcastReceiver
{
	...
	public void onReceive(Context context, Intent intent)
	{
		...
		Intent service = new Intent(context,
		        votealarmNotficationcreateService.class);
	...
	public void setAlarm(Context context)
	{
		...
		Intent intent = new Intent(context, votealarmReciver.class);
		...
		//util.log(calendar.getTime()+"setlog wird durchgeführt mit wert:"+calendar.getTimeInMillis());
        ...
        // device is rebooted.
        ComponentName receiver = new ComponentName(context, voteBooteReciver.class);
